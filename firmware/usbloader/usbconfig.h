 ...
 */
#define USB_CFG_VENDOR_NAME     'd', 'e', 'l', 'i', '.', 's', 'u'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'T', 'i', 'n', 'y', 'H', 'I', 'D', ' ', 'L', 'o', 'a', 'd', 'e', 'r'
 ...
 * protocol.
 */
#define USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH    22  /* total length of report descriptor */
